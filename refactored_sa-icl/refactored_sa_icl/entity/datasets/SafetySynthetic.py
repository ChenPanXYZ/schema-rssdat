...
class SafetySynthetic(Dataset):
    dataset_name: str = "SafetySynthetic"
    ...
    def load_problems(self):
        ...
        csv_path = os.path.join(path, 'raw_files/raw_files/safety_knowledges.csv')
        ...
        for i, row in df.iterrows():
            try:
                ...
                problem = Problem(
                    ...
                    reference_to=str(row['reference_to']),
                    reference_type='new_question'
                )
...
if __name__ == "__main__":
    # Test the loader
    dataset = SafetySynthetic(size=10000)
